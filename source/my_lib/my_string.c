...
// ----------------------------------------------------------------------------
void my_perror(int errnum, const char *format, ...)
{
	va_list ap;
	char buf[BUFF_MAX];
	char str[BUFF_MAX];
...
// ----------------------------------------------------------------------------
int my_dirname(const char *path, char *dname, size_t dname_len, char *fname, size_t fname_len)
{
	char buf[BUFF_MAX];
	char *p;
	char *s = buf;
...
// ----------------------------------------------------------------------------
int my_basename(const char *path, char *bname, size_t bname_len, char *ename, size_t ename_len)
{
	char buf[BUFF_MAX];
	char *p;
	char *s = buf;
