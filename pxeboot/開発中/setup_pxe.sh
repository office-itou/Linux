...
# --- tftp directory ----------------------------------------------------------
	declare -r    DIRS_TFTP="/var/tftp"

# --- http directory ----------------------------------------------------------
	declare -r    DIRS_HTTP="/var/www/html/pxe"

# --- vmware shared directory -------------------------------------------------
	declare -r    DIRS_HGFS="/mnt/hgfs/workspace/Image"

# --- configuration file's directory ------------------------------------------
	declare -r    DIRS_TMPL="${PWD}/mkcd"

# --- http server address -----------------------------------------------------
	declare       ADDR_HTTP="http://192.168.1.10/pxe"

# --- network address ---------------------------------------------------------
	declare       IPV4_ADDR="192.168.1.1/24"
	declare       IPV4_MASK="255.255.255.0"
	declare       IPV4_GWAY="192.168.1.254"
	declare       IPV4_NSVR="192.168.1.254"
...
#	 9: iso image file copy source directory
	declare -r -a DATA_LIST=(                                                                                                                                                                                                                                                     \
		...
		"o  ubuntu-server-18.04         Ubuntu%2018.04%20Server             ubuntu          ubuntu-18.04.6-server-amd64.iso             install             initrd.gz                   vmlinuz                 conf/preseed/ps_ubuntu_server_old.cfg       linux/ubuntu        " \
...
function funcMake_nocloud() {
	...
	declare       DIRS_NAME=""
	declare -r    FILE_TMPL="${PWD}/mkcd/nocloud-ubuntu-user-data"
...
function funcMake_kickstart() {
	...
	declare       FILE_PATH=""
	declare       FILE_NAME=""
	declare -r    FILE_TMPL="${PWD}/mkcd/kickstart_common.cfg"
	declare       DSTR_NAME=""
	declare       DSTR_NUMS=""
	declare       RLNX_NUMS=""
...
function funcMake_autoyast() {
	...
	declare       FILE_PATH=""
	declare       FILE_NAME=""
	declare -r    FILE_TMPL="${PWD}/mkcd/yast_opensuse.xml"
	declare       DSTR_NUMS=""
	declare -r    BASE_ARCH="x86_64"
