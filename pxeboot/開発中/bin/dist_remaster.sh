...
##	2023/11/05 000.0000 J.Itou         リスト更新: Ubuntu 24.04(Noble_Numbat) 追加
##	2023/11/06 000.0000 J.Itou         処理見直し
##	2023/11/09 000.0000 J.Itou         リスト更新: Fedora 39/40 追加
##	2023/11/18 000.0000 J.Itou         処理見直し
...
#		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/37/Server/x86_64/iso/Fedora-Server-netinst-x86_64-37-[0-9.]*.iso               ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2022-11-15  2023-11-14  -           kernel_6.0          -                                   " \ #
		...
		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/39/Server/x86_64/iso/Fedora-Server-netinst-x86_64-39-[0-9.]*.iso               ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2023-11-07  2024-11-12  -           kernel_6.5          -                                   " \
#		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/40/Server/x86_64/iso/Fedora-Server-netinst-x86_64-40-[0-9.]*.iso               ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2024-04-16  2025-05-13  -           kernel_x.x          -                                   " \ #
...
# x		"ubuntu             kinetic.server      https://releases.ubuntu.com/kinetic/ubuntu-22.10[0-9.]*-live-server-${ARC_TYPE}.iso                                                         ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2022-10-20  2023-07-20  -           Kinetic_Kudu        Ubuntu_22.10(Kinetic_Kudu)          " \ #
		...
		"ubuntu             mantic.server       https://releases.ubuntu.com/mantic/ubuntu-23.10[0-9.]*-live-server-${ARC_TYPE}.iso                                                          ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2023-10-12  2024-07-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \
#		"ubuntu             noble.server        https://releases.ubuntu.com/noble/ubuntu-24.04[0-9.]*-live-server-${ARC_TYPE}.iso                                                           ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
#		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/37/Server/x86_64/iso/Fedora-Server-dvd-x86_64-37-[0-9.]*.iso                   ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2022-11-15  2023-11-14  -           kernel_6.0          -                                   " \ #
		...
		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/39/Server/x86_64/iso/Fedora-Server-dvd-x86_64-39-[0-9.]*.iso                   ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2023-11-07  2024-11-12  -           kernel_6.2          -                                   " \
#		"fedora             -                   https://download.fedoraproject.org/pub/fedora/linux/releases/40/Server/x86_64/iso/Fedora-Server-dvd-x86_64-40-[0-9.]*.iso                   ./${WORK_DIRS}                              -                                           -                   -           kickstart_common.cfg                            2024-04-16  2025-05-13  -           kernel_x.x          -                                   " \ #
...
# x		"ubuntu             kinetic.desktop     https://releases.ubuntu.com/kinetic/ubuntu-22.10[0-9.]*-desktop-${ARC_TYPE}.iso                                                             ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2022-10-20  2023-07-20  -           Kinetic_Kudu        Ubuntu_22.10(Kinetic_Kudu)          " \ #
		...
		"ubuntu             lunar.legacy        https://cdimage.ubuntu.com/releases/lunar/release/ubuntu-23.04[0-9.]*-desktop-legacy-${ARC_TYPE}.iso                                        ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2023-04-20  2024-01-20  -           Lunar_Lobster       Ubuntu_23.04(Lunar_Lobster)         " \
		"ubuntu             mantic.desktop      https://releases.ubuntu.com/mantic/ubuntu-23.10[0-9.]*-desktop-${ARC_TYPE}.iso                                                              ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2023-10-12  2024-07-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \
		"ubuntu             mantic.legacy       https://cdimage.ubuntu.com/releases/mantic/release/ubuntu-23.10[0-9.]*-desktop-legacy-${ARC_TYPE}.iso                                       ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2023-10-12  2024-07-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \
#		"ubuntu             noble.desktop       https://releases.ubuntu.com/noble/ubuntu-24.04[0-9.]*-desktop-${ARC_TYPE}.iso                                                               ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
#		"ubuntu             noble.legacy        https://cdimage.ubuntu.com/releases/mantic/release/ubuntu-24.04[0-9.]*-desktop-legacy-${ARC_TYPE}.iso                                       ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
		"ubuntu             noble.server        https://cdimage.ubuntu.com/ubuntu-server/daily-live/current/noble-live-server-${ARC_TYPE}.iso                                               ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \
		"ubuntu             noble.desktop       https://cdimage.ubuntu.com/daily-live/current/noble-desktop-${ARC_TYPE}.iso                                                                 ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \
#		"ubuntu             noble.legacy        https://cdimage.ubuntu.com/daily-legacy/current/noble-desktop-legacy-${ARC_TYPE}.iso                                                        ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
#		"ubuntu             mantic.server       https://cdimage.ubuntu.com/ubuntu-server/daily-live/current/mantic-live-server-${ARC_TYPE}.iso                                              ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2023-10-12  20xx-xx-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \ #
#		"ubuntu             mantic.desktop      https://cdimage.ubuntu.com/daily-live/current/mantic-desktop-${ARC_TYPE}.iso                                                                ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2023-10-12  20xx-xx-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \ #
#		"ubuntu             mantic.legacy       https://cdimage.ubuntu.com/daily-legacy/current/mantic-desktop-legacy-${ARC_TYPE}.iso                                                       ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2023-10-12  20xx-xx-xx  -           Mantic_Minotaur     Ubuntu_23.10(Mantic_Minotaur)       " \ #
	)	#0:distribution     1:codename          2:download URL                                                                                                                              3:directory                                 4:alias                                     5:iso file size     6:file date 7:definition file                               8:release   9:support   10:status   11:memo1            12:memo2                            
...
#		"debian             trixie.live         -                                                                                                                                           ./${WORK_DIRS}                              -                                           -                   -           preseed_debian.cfg                              202x-xx-xx  20xx-xx-xx  -           testing             Debian_13.xx(trixie)                " \ #
		...
		"ubuntu             focal.desktop       https://releases.ubuntu.com/focal/ubuntu-20.04[0-9.]*-desktop-${ARC_TYPE}.iso                                                               ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2020-04-23  2030-04-23  -           Focal_Fossa         Ubuntu_20.04(Focal_Fossa):LTS       " \
		"ubuntu             jammy.desktop       https://releases.ubuntu.com/jammy/ubuntu-22.04[0-9.]*-desktop-${ARC_TYPE}.iso                                                               ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2022-04-21  2032-04-21  -           Jammy_Jellyfish     Ubuntu_22.04(Jammy_Jellyfish):LTS   " \
# x		"ubuntu             kinetic.desktop     https://releases.ubuntu.com/kinetic/ubuntu-22.10[0-9.]*-desktop-${ARC_TYPE}.iso                                                             ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2022-10-20  2023-07-xx  -           Kinetic_Kudu        Ubuntu_22.10(Kinetic_Kudu)          " \ #
		"ubuntu             lunar.desktop       https://releases.ubuntu.com/lunar/ubuntu-23.04[0-9.]*-desktop-${ARC_TYPE}.iso                                                               ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2023-04-20  2024-01-20  -           Lunar_Lobster       Ubuntu_23.04(Lunar_Lobster)         " \
		"ubuntu             lunar.legacy        https://cdimage.ubuntu.com/releases/lunar/release/ubuntu-23.04[0-9.]*-desktop-legacy-${ARC_TYPE}.iso                                        ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2023-04-20  2024-01-20  -           Lunar_Lobster       Ubuntu_23.04(Lunar_Lobster)         " \
		"ubuntu             noble.desktop       https://cdimage.ubuntu.com/daily-live/current/noble-desktop-${ARC_TYPE}.iso                                                                 ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \
#		"ubuntu             noble.legacy        https://cdimage.ubuntu.com/daily-legacy/current/noble-desktop-legacy-${ARC_TYPE}.iso                                                        ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
...
# -----------------------------------------------------------------------------
	# [ ipaddress:gateway:netmask:hostname:interface:nameserver ]
	CFG_NETWORK="192.168.1.1:192.168.1.254:255.255.255.0:sv-_HOSTNAME_.workgroup:ens160:192.168.1.254"
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
funcCreate_kill_dhcp () {
	declare -r COMD_FILE="$1/preseed_kill_dhcp.sh"
	funcPrintf "    create_kill_dhcp"
	# -------------------------------------------------------------------------
...
#	DIR_NAME=${CODE_NAME[4]%/*}
	...
	pushd ${WORK_DIRS}/${CODE_NAME[1]} > /dev/null
		...
		if [ ! -f "../${DVD_NAME}.iso" ]; then
			...
			set +e
			curl -L -# -R -S -f --create-dirs --connect-timeout 60 --retry 3 -o "../${DVD_NAME}.iso" "${DVD_URL}"
			RET_CD=$?
			if [ ${RET_CD} -ne 0 ]; then
				for ((I=0; I<3; I++))
				do
					curl -C - -L -# -R -S -f --create-dirs --connect-timeout 60 --retry 3 -o "../${DVD_NAME}.iso" "${DVD_URL}"
					RET_CD=$?
				done
			fi
			if [ ${RET_CD} -eq 18 -o ${RET_CD} -eq 22 -o ${RET_CD} -eq 28 -o ${RET_CD} -eq 56 ]; then return 1; fi
			set -e
		else
...
#							funcCreate_success_command "./preseed"
					...
					case "${CODE_NAME[1]}" in
						ubuntu-*-desktop* )
							OLD_IFS=${IFS}
							IFS= INS_STR=$(
								sed -n '/^[^#].*preseed\/late_command/,/[^\\]$/p' "preseed/preseed.cfg" | \
								sed -e 's/\\/\\\\/g'                                                      \
								    -e 's/d-i/ubiquity/'                                                  \
					...
					sed -e '/^[ \t]*d-i[ \t]\+pkgsel\/include[ \t]\+/,/\(^[# \t]*d-i[ \t]\+\|^#.*-$\)/                       { ' \
					    -e ':l; /\(^[# \t]*d-i[ \t]\+\|^#.*-$\)/! { /^#.*[^-]*$/! { /\\$/! s/$/ \\/ }; s/^# /  /; n; b l; }; } ' \
					    "preseed/preseed.cfg"                                                                                    \
					>   "preseed/preseed_desktop.cfg"
					case "${CODE_NAME[1]}" in
						*mini* )
...
#								cp --preserve=timestamps "../image/preseed/preseed_desktop.cfg"    "./"
								cp --preserve=timestamps "../image/preseed/preseed_kill_dhcp.sh"   "./"
...
#								    -e '/^[^#].*preseed\/late_command/,/[^\\]$/ s~/cdrom/preseed~~'
				...
				"almalinux"    )	# --- get ks.cfg ----------------------------------
					...
					ARC_NUM="x86_64"
					case "${CODE_NAME[0]}" in
						fedora       ) VER_NUM=$(echo "${CODE_NAME[1]}" | awk -F '[-.]' '{print $5;}'); RHL_NUM="9";; #VER_NUM=$(($(echo "${CODE_NAME[1]}" | awk -F '[-.]' '{print $5;}') - 29));;
						centos       ) VER_NUM=$(echo "${CODE_NAME[1]}" | awk -F '[-.]' '{print $3;}'); RHL_NUM="${VER_NUM}"; WRK_TEXT="${CODE_NAME[0]} .*${VER_NUM}";;
						almalinux    ) ;;
						rockylinux   ) ;;
						miraclelinux ) ;;
						*            ) ;;
...
#					esac
			...
			# --- Get Networ parameter ----------------------------------------
			# [ ipaddress:gateway:netmask:hostname:interface:nameserver ]
			# CFG_NETWORK="192.168.1.1:192.168.1.254:255.255.255.0:sv-_HOSTNAME_.workgroup:ens160:192.168.1.254"
			CFG_IPADDRESS="$(echo "${CFG_NETWORK}" | awk -F ':' '{print $1;}')"
			CFG_GATEWAY="$(echo "${CFG_NETWORK}" | awk -F ':' '{print $2;}')"
			CFG_NETMASK="$(echo "${CFG_NETWORK}" | awk -F ':' '{print $3;}')"
			CFG_HOSTNAME="$(echo "${CFG_NETWORK}" | awk -F ':' 'sub("_HOSTNAME_",'\""${CODE_NAME[0]}"\"',$4) {print $4;}')"
			CFG_INTERFACE="$(echo "${CFG_NETWORK}" | awk -F ':' '{print $5;}')"
			CFG_NAMESERVER="$(echo "${CFG_NETWORK}" | awk -F ':' '{print $6;}')"
			CFG_NETMASK_BIT="$(funcIPv4GetNetmaskBits " ${CFG_NETMASK}")"
#			echo "CFG_IPADDRESS : ${CFG_IPADDRESS}"
#			echo "CFG_GATEWAY   : ${CFG_GATEWAY}"
#			echo "CFG_NETMASK   : ${CFG_NETMASK}"
#			echo "CFG_HOSTNAME  : ${CFG_HOSTNAME}"
#			echo "CFG_INTERFACE : ${CFG_INTERFACE}"
#			echo "CFG_NAMESERVER: ${CFG_NAMESERVER}"
#			echo "HOSTNAME [S}  : ${CFG_HOSTNAME%.*}"
#			echo "HOSTNAME [D}  : ${CFG_HOSTNAME#*.}"
#			echo "NETMASK [bit] : ${CFG_NETMASK_BIT}"
#			echo "NETMASK [rev] : $(funcIPv4GetNetmask "${CFG_NETMASK_BIT}")")"
...
#					sed -i gtk.cfg      -e '/^.*menu default.*$/d'
					...
					INS_CFG="fsck.mode=skip netcfg\/disable_autoconfig=true"
					INS_CFG+=" netcfg\/disable_autoconfig=true"
					INS_CFG+=" netcfg\/choose_interface=ens160"
					INS_CFG+=" netcfg\/get_hostname=${CFG_HOSTNAME}"
					INS_CFG+=" netcfg\/get_ipaddress=${CFG_IPADDRESS}\/${CFG_NETMASK_BIT}"
					INS_CFG+=" netcfg\/get_gateway=${CFG_GATEWAY}"
					INS_CFG+=" netcfg\/get_nameservers=${CFG_NAMESERVER}"
#					INS_CFG="netcfg\/disable_autoconfig=true netcfg\/get_hostname=sv-${CODE_NAME[0]}.workgroup netcfg\/get_ipaddress=192.168.1.1\/24 netcfg\/get_gateway=192.168.1.254 netcfg\/get_nameservers=192.168.1.254"
					if [ ${INS_ROW} -ge 1 ]; then
						sed -n '/label install/,/append/p' txt.cfg                                                          | \
						sed -e 's/^\(label\) install/\1 autoinst/'                                                            \
						    -e 's/\(Install\)/Auto \1/'                                                                       \
						    -e "s/initrd.gz/initps.gz/"                                                                       \
						    -e "/^[[:blank:]]*append[[:blank:]]\+/ s/^\(.*[[:graph:]]\)\([[:blank:]]*\r*\)$/\1 ${INS_CFG}\2/" \
...
#					INS_CFG="netcfg\/disable_autoconfig=true netcfg\/get_hostname=sv-${CODE_NAME[0]}.workgroup netcfg\/get_ipaddress=192.168.1.1\/24 netcfg\/get_gateway=192.168.1.254 netcfg\/get_nameservers=192.168.1.254"
					if [ ${INS_ROW} -ge 1 ]; then
						...
						sed -e 's/\(Install\)/Auto \1/'                                                                      \
						    -e "s/initrd.gz/initps.gz/"                                                                      \
						    -e "/^[[:blank:]]*linux[[:blank:]]\+/ s/^\(.*[[:graph:]]\)\([[:blank:]]*\r*\)$/\1 ${INS_CFG}\2/" \
						    -e 's/\(--hotkey\)=./\1=a/'                                                                    | \
					...
					case "${CODE_NAME[0]}" in
						"debian" )	# ･････････････････････････････････････････
							case "${CODE_NAME[1]}" in
								*-live-* )
									# === 日本語化 ============================
									INS_CFG="fsck.mode=skip locales=ja_JP.UTF-8 timezone=Asia\/Tokyo keyboard-model=jp106 keyboard-layouts=jp"
									# --- grub.cfg --------------------------------------------------------
									touch grub.cfg
									...
									sed -i isolinux/isolinux.cfg     \
									    -e 's/\(timeout\).*$/\1 50/'
									# === preseed =============================
									INS_CFG="fsck.mode=skip auto=true file=\/cdrom\/preseed\/preseed.cfg"
									INS_CFG+=" netcfg\/disable_autoconfig=true"
									INS_CFG+=" netcfg\/choose_interface=ens160"
									INS_CFG+=" netcfg\/get_hostname=${CFG_HOSTNAME}"
									INS_CFG+=" netcfg\/get_ipaddress=${CFG_IPADDRESS}\/${CFG_NETMASK_BIT}"
...
#									INS_CFG+=" netcfg\/disable_autoconfig=true netcfg\/get_hostname=sv-${CODE_NAME[0]}.workgroup netcfg\/get_ipaddress=192.168.1.1\/24 netcfg\/get_gateway=192.168.1.254 netcfg\/get_nameservers=192.168.1.254"
							...
							# -------------------------------------------------
							if [ -f isolinux/spkgtk.cfg ]; then
								sed -i isolinux/spkgtk.cfg        \
								    -e '/^timeout/       s/^/#/g' \
								    -e '/^ontimeout/     s/^/#/g' \
								    -e '/^menu autoboot/ s/^/#/g'
							fi
...
#											export IP=$ipaddr::$gateway:$netmask::$DEVICE:$proto:$dns
											INS_CFG="fsck.mode=skip autoinstall \"ds=nocloud-net;s=file:\/\/\/cdrom\/nocloud\/\""
											INS_CFG+=" hostname=${CFG_HOSTNAME}"
											INS_CFG+=" ip=${CFG_IPADDRESS}::${CFG_GATEWAY}:${CFG_NETMASK}::${CFG_INTERFACE}:static:${CFG_NAMESERVER}"
#											INS_CFG+=" nameserver=${CFG_NAMESERVER}"
...
#									if [ -f "nocloud/user-data" ]; then 
										INS_CFG="fsck.mode=skip autoinstall \"ds=nocloud-net;s=file:\/\/\/cdrom\/nocloud\/\""
										INS_CFG+=" hostname=${CFG_HOSTNAME}"
										INS_CFG+=" ip=${CFG_IPADDRESS}::${CFG_GATEWAY}:${CFG_NETMASK}::${CFG_INTERFACE}"
										INS_CFG+=" nameserver=${CFG_NAMESERVER}"
#										INS_CFG="fsck.mode=skip autoinstall \"ds=nocloud-net;s=file:\/\/\/cdrom\/nocloud\/\" ip=dhcp ipv6.disable=1"
#										INS_CFG+=" debian-installer\/locale=ja_JP.UTF-8 keyboard-configuration\/layoutcode\=jp keyboard-configuration\/modelcode\=jp106"
#										INS_CFG+=" timezone=Asia\/Tokyo"
#										INS_CFG+=" automatic-ubiquity noprompt"
#										INS_CFG+=" iso-url=https:\/\/cdimage.ubuntu.com\/daily-live\/current\/lunar-desktop-amd64\.iso"
#									else
#										INS_CFG="fsck.mode=skip auto=true file=\/cdrom\/preseed\/preseed.cfg"
#										INS_CFG+=" netcfg\/disable_autoconfig=true"
#										INS_CFG+=" netcfg\/get_hostname=${CFG_HOSTNAME}"
...
#									fi
							...
							if [ -f "preseed/preseed_desktop.cfg"    ]; then chmod 444 "preseed/preseed_desktop.cfg";    fi
#							if [ -f "preseed/sub_success_command.sh" ]; then chmod 544 "preseed/sub_success_command.sh"; fi
						...
						"miraclelinux" | \
						"almalinux"    )	# ･････････････････････････････････
							INS_CFG="fsck.mode=skip inst.ks=hd:sr0:\/kickstart\/ks.cfg"
							INS_CFG+=" ip=${CFG_IPADDRESS}::${CFG_GATEWAY}:${CFG_NETMASK}:${CFG_HOSTNAME}:${CFG_INTERFACE}:none,auto6"
							INS_CFG+=" nameserver=${CFG_NAMESERVER}"
#							INS_CFG="inst.ks=cdrom:\/kickstart\/ks.cfg"
#							INS_CFG="inst.ks=hd:sr0:\/kickstart\/ks.cfg"
#							INS_CFG+=" ip=dhcp ipv6.disable=0"
#							INS_CFG+=" ip=192.168.1.1::192.168.1.254:255.255.255.0:sv-${CODE_NAME[0]}.workgroup:ens160:none,auto6 nameserver=192.168.1.254"
							# --- isolinux.cfg --------------------------------
							if [ -f isolinux/isolinux.cfg ]; then
							...
							# --- grub.cfg ------------------------------------
							for GRUB_CFG in EFI/BOOT/grub.cfg boot/grub2/grub.cfg
							do
								if [ -f ${GRUB_CFG} ]; then
									INS_ROW=$((`sed -n '/^menuentry/ =' ${GRUB_CFG} | awk 'NR==1 {print}'`-1))
									if [ ${INS_ROW} -ge 0 ]; then
										sed -n '/^menuentry '\''Install/,/^}/p' ${GRUB_CFG}                | \
										sed -e 's/\(Install\)/Auto \1/'                                      \
										    -e "/^[[:blank:]]*linux\(\|efi\)[[:blank:]]/ s/$/ ${INS_CFG}/" | \
										sed -e "${INS_ROW}r /dev/stdin" ${GRUB_CFG}                        | \
										sed -e 's/\(set default\)="1"/\1="0"/'                               \
										    -e 's/\(set timeout\).*$/\1=5/'                                  \
										> grub.cfg
										mv grub.cfg ${GRUB_CFG%/*}
									fi
								fi
							done
							# -------------------------------------------------
							...
							;;
						"opensuse" )	# ･････････････････････････････････････
							INS_CFG="fsck.mode=skip autoyast=cd:\/autoyast\/autoinst\.xml"
							INS_CFG+=" hostname=${CFG_HOSTNAME}"
							INS_CFG+=" ifcfg=e*=${CFG_IPADDRESS}\/${CFG_NETMASK_BIT},${CFG_GATEWAY},${CFG_NAMESERVER},${CFG_HOSTNAME#*.}"
#							INS_CFG="autoyast=cd:\/autoyast\/autoinst\.xml ifcfg=e*=dhcp"
#							INS_CFG="autoyast=cd:\/autoyast\/autoinst\.xml ip=dhcp ipv6.disable=0"
#							INS_CFG+=" hostname=sv-${CODE_NAME[0]}.workgroup ifcfg=e*=192.168.1.1\/24,192.168.1.254,192.168.1.254,workgroup"
							# --- isolinux.cfg --------------------------------
