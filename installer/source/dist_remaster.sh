...
#		"ubuntu             noble.server        http://cdimage.ubuntu.com/ubuntu-server/daily-live/current/noble-live-server-${ARC_TYPE}.iso                                                ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
#		"ubuntu             noble.desktop       http://cdimage.ubuntu.com/daily-live/current/noble-desktop-${ARC_TYPE}.iso                                                                  ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg,nocloud-ubuntu-user-data     2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
#		"ubuntu             noble.legacy        http://cdimage.ubuntu.com/daily-legacy/current/noble-desktop-legacy-${ARC_TYPE}.iso                                                         ./${WORK_DIRS}                              -                                           -                   -           preseed_ubuntu.cfg                              2024-04-25  2029-05-31  -           Noble_Numbat        Ubuntu_24.04(Noble_Numbat):LTS      " \ #
