...
# -----------------------------------------------------------------------------
	readonly ARRAY_NAME=(                                                                                                                                                                                 \
	    ...
	    "centos CentOS-Stream-8-x86_64-20210215-boot   http://ftp.iij.ad.jp/pub/linux/centos/8-stream/isos/x86_64/CentOS-Stream-8-x86_64-20210215-boot.iso                          kickstart_centos.cfg" \
...
fncMenu () {
	...
	echo "#  6：CentOS-Stream-8-x86_64-20210215-boo：20xx-xx-xx：20xx-xx-xx：RHEL x.x   #"
