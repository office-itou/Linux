...
##	2022/04/23 000.0000 J.Itou         memo更新
...
# -----------------------------------------------------------------------------
	ARRAY_NAME=(                                                                                                                                                                                                                                                                                \
	    "debian         https://cdimage.debian.org/cdimage/archive/latest-oldoldstable/amd64/iso-cd/debian-[0-9].*-amd64-netinst.iso                             -                                           preseed_debian.cfg                          2017-06-17 2022-06-30 oldoldstable   " \
