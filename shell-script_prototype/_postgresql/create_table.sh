...
echo "*** create table distribution ***"
...
INSERT INTO public.distribution(version,name,version_id,code_name,life,release,support,long_term,rhel,kerne,note) values 
  ...
  , ('fedora-42','Fedora','42',NULL,NULL,'2025-04-22','2026-05-13',NULL,NULL,NULL,NULL)
...
#	    , LPAD(SPLIT_PART(SubString(regexp_replace(public.media.latest, '^[^0-9]+', ' ') FROM '[0-9.]+$'), '.', 1), 3, '0')
#	    , LPAD(SPLIT_PART(SubString(regexp_replace(public.media.latest, '^[^0-9]+', ' ') FROM '[0-9.]+$'), '.', 2), 3, '0')
#	    , LPAD(SPLIT_PART(SubString(regexp_replace(public.media.latest, '^[^0-9]+', ' ') FROM '[0-9.]+$'), '.', 3), 3, '0')
#	;
