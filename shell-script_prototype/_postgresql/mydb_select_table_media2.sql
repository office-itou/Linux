SELECT
    ...
    , public.distribution.version_id AS latest
    , public.distribution.release AS release
    , public.distribution.support AS support
...
FROM
    public.media
    LEFT JOIN public.distribution
        ON public.media.version = public.distribution.version
ORDER BY
