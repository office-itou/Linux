...
#   g-var : _DATA_CONF : read
#   g-var : _DATA_DIST : read
#   g-var : _DATA_MDIA : read
#   g-var : _DATA_DSTP : read
...
#   g-var : _TMPL_KICK : read
#   g-var : _TMPL_CLUD : read
#   g-var : _TMPL_SEDD : read
#   g-var : _TMPL_SEDU : read
#   g-var : _TMPL_YAST : read
#   g-var : _TMPL_AGMA : read
...
function fnPut_conf_data() {
	...
	cat <<- _EOT_ | sed -e '/^ [^ ]\+/ s/^ *//g' -e 's/^ \+$//g' > "${1:?}"
		...
		$(printf "%-39s %s" "DATA_CONF=\"${_DATA_CONF:-":_DIRS_DATA_:/:_FILE_CONF_:"}\"" "# common configuration file")
		$(printf "%-39s %s" "DATA_DIST=\"${_DATA_DIST:-":_DIRS_DATA_:/:_FILE_DIST_:"}\"" "# distribution data file"   )
		$(printf "%-39s %s" "DATA_MDIA=\"${_DATA_MDIA:-":_DIRS_DATA_:/:_FILE_MDIA_:"}\"" "# media data file"          )
		$(printf "%-39s %s" "DATA_DSTP=\"${_DATA_DSTP:-":_DIRS_DATA_:/:_FILE_DSTP_:"}\"" "# debstrap data file"       )
		...
		$(printf "%-39s %s" "TMPL_KICK=\"${_TMPL_KICK:-":_DIRS_TMPL_:/:_FILE_KICK_:"}\"" "# for rhel"             )
		$(printf "%-39s %s" "TMPL_CLUD=\"${_TMPL_CLUD:-":_DIRS_TMPL_:/:_FILE_CLUD_:"}\"" "# for ubuntu cloud-init")
		$(printf "%-39s %s" "TMPL_SEDD=\"${_TMPL_SEDD:-":_DIRS_TMPL_:/:_FILE_SEDD_:"}\"" "# for debian"           )
		$(printf "%-39s %s" "TMPL_SEDU=\"${_TMPL_SEDU:-":_DIRS_TMPL_:/:_FILE_SEDU_:"}\"" "# for ubuntu"           )
		$(printf "%-39s %s" "TMPL_YAST=\"${_TMPL_YAST:-":_DIRS_TMPL_:/:_FILE_YAST_:"}\"" "# for opensuse"         )
		$(printf "%-39s %s" "TMPL_AGMA=\"${_TMPL_AGMA:-":_DIRS_TMPL_:/:_FILE_AGMA_:"}\"" "# for opensuse"         )
		...
		$(printf "%-39s %s" "SHEL_ERLY=\"${_SHEL_ERLY:-":_DIRS_SHEL_:/:_FILE_ERLY_:"}\"" "# shell commands to run early"           )
		$(printf "%-39s %s" "SHEL_LATE=\"${_SHEL_LATE:-":_DIRS_SHEL_:/:_FILE_LATE_:"}\"" "# \"              to run late"           )
		$(printf "%-39s %s" "SHEL_PART=\"${_SHEL_PART:-":_DIRS_SHEL_:/:_FILE_PART_:"}\"" "# \"              to run after partition")
		$(printf "%-39s %s" "SHEL_RUNS=\"${_SHEL_RUNS:-":_DIRS_SHEL_:/:_FILE_RUNS_:"}\"" "# \"              to run preseed/run"    )
