...
###############################################################################
#
#	autoinstall (early) shell script
...
# *** function section (subroutine functions) *********************************
	...
	# shellcheck source=/dev/null
	. "${_SHEL_TOPS}"/fnSetup_wireplumber.sh				# wireplumber (alsa) settings
	# shellcheck source=/dev/null
	. "${_SHEL_TOPS}"/fnGet_conf_file.sh					# get auto-installation configuration file
...
fnMain() {
	...
	fnGet_conf_file						# get auto-installation configuration file
