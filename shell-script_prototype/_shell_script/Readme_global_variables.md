...
|    name    |                   descript                   |                        example                        |
| :--------: | :------------------------------------------- | :---------------------------------------------------- |
| _DIRS_SHAR | shared of user file                          | [/srv/user/share]                                     |
...
| _NTPS_ADDR | ntp server address                           | [ntp.nict.jp]                                         |
| _NTPS_IPV4 | ntp server ipv4 addr                         | [61.205.120.130]                                      |
...
|    name    |                   descript                   |                        example                        |
| :--------: | :------------------------------------------- | :---------------------------------------------------- |
| _COMD_LINE | cat /proc/cmdline                            | [BOOT_IMAGE=/vmlinuz-6.12.48+deb13-amd64 root=/dev/mapper/sv--developer--vg-root ro quiet security=apparmor apparmor=1] |
| _NICS_NAME | network device name (dual use)               | [ens160]                                              |
| _NICS_MADR | network device mac  (dual use)               | [00:00:00:00:00:00]                                   |
| _NICS_AUTO | ipv4 dhcp (empty or dhcp)                    | [],[dhcp]                                             |
...
| _NMAN_FLAG | network manager name                         | [nm_config],[ifupdown],[loopback]                     |
| _DIRS_TGET | target directory                             | [/target],[/mnt/sysimage],[/mnt/]                     |
| _FILE_ISOS | iso file name (iso-url=*.iso, ...)           | []                                                    |
| _FILE_SEED | preseed file name (preseed/file=*, ...)      | []                                                    |
