...
function funcTrap() {
	...
	declare -r -a _LIST_MDIA=( \
		...
		"mini.iso        s               debian-mini-11                          Debian%2011                             debian-11.0             debian-11.0             2021-08-14      2024-08-15      https://deb.debian.org/debian/dists/bullseye/main/installer-amd64/current/images/netboot/mini.iso                                               https://deb.debian.org/debian/dists/bullseye/main/installer-amd64/current/images/netboot/mini.iso                                               -                           -               -               :_DIRS_ISOS_:/mini-bullseye-amd64.iso                                                 2024-08-27%2006:14:31+09    54525952        ISOIMAGE                                    :_DIRS_RMAK_:/mini-bullseye-amd64_preseed.iso                                         -                           -               -                                           :_DIRS_LOAD_:/debian-mini-11/initrd.gz                                                :_DIRS_LOAD_:/debian-mini-11/linux                                                    :_DIRS_CONF_:/preseed/ps_debian_server_old.cfg                                        -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"mini.iso        s               debian-mini-12                          Debian%2012                             debian-12.0             debian-12.0             2023-06-10      2026-06-xx      https://deb.debian.org/debian/dists/bookworm/main/installer-amd64/current/images/netboot/mini.iso                                               https://deb.debian.org/debian/dists/bookworm/main/installer-amd64/current/images/netboot/mini.iso                                               -                           -               -               :_DIRS_ISOS_:/mini-bookworm-amd64.iso                                                 2025-03-10%2012:28:07+09    65011712        ISOIMAGE                                    :_DIRS_RMAK_:/mini-bookworm-amd64_preseed.iso                                         -                           -               -                                           :_DIRS_LOAD_:/debian-mini-12/initrd.gz                                                :_DIRS_LOAD_:/debian-mini-12/linux                                                    :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"mini.iso        s               debian-mini-13                          Debian%2013                             debian-13.0             debian-13.0             2025-xx-xx      20xx-xx-xx      https://deb.debian.org/debian/dists/trixie/main/installer-amd64/current/images/netboot/mini.iso                                                 https://deb.debian.org/debian/dists/trixie/main/installer-amd64/current/images/netboot/mini.iso                                                 -                           -               -               :_DIRS_ISOS_:/mini-trixie-amd64.iso                                                   2024-12-27%2009:14:03+09    65011712        ISOIMAGE                                    :_DIRS_RMAK_:/mini-trixie-amd64_preseed.iso                                           -                           -               -                                           :_DIRS_LOAD_:/debian-mini-13/initrd.gz                                                :_DIRS_LOAD_:/debian-mini-13/linux                                                    :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		...
		"mini.iso        s               debian-mini-testing                     Debian%20testing                        debian-testing          debian-testing          20xx-xx-xx      20xx-xx-xx      https://ftp.debian.org/debian/dists/testing/main/installer-amd64/current/images/netboot/mini.iso                                                https://deb.debian.org/debian/dists/testing/main/installer-amd64/current/images/netboot/mini.iso                                                -                           -               -               :_DIRS_ISOS_:/mini-testing-amd64.iso                                                  2024-12-27%2009:14:03+09    65011712        ISOIMAGE                                    :_DIRS_RMAK_:/mini-testing-amd64_preseed.iso                                          -                           -               -                                           :_DIRS_LOAD_:/debian-mini-testing/initrd.gz                                           :_DIRS_LOAD_:/debian-mini-testing/linux                                               :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"mini.iso        s               debian-mini-testing-daily               Debian%20testing%20daily                debian-testing          debian-testing          20xx-xx-xx      20xx-xx-xx      https://d-i.debian.org/daily-images/amd64/daily/netboot/mini.iso                                                                                https://d-i.debian.org/daily-images/amd64/daily/netboot/mini.iso                                                                                -                           -               -               :_DIRS_ISOS_:/mini-testing-daily-amd64.iso                                            2025-04-17%2000:02:11+09    67108864        ISOIMAGE                                    :_DIRS_RMAK_:/mini-testing-daily-amd64_preseed.iso                                    -                           -               -                                           :_DIRS_LOAD_:/debian-mini-testing-daily/initrd.gz                                     :_DIRS_LOAD_:/debian-mini-testing-daily/linux                                         :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		...
		"dvd             s               debian-testing                          Debian%20testing                        debian-testing          debian-testing          20xx-xx-xx      20xx-xx-xx      https://cdimage.debian.org/cdimage/weekly-builds/amd64/iso-dvd/debian-testing-amd64-DVD-1.iso                                                   https://cdimage.debian.org/cdimage/weekly-builds/amd64/iso-dvd/debian-testing-amd64-DVD-1.iso                                                   -                           -               -               :_DIRS_ISOS_:/debian-testing-amd64-DVD-1.iso                                          2025-04-14%2005:44:13+09    3989078016      Debian%20testing%20amd64%201                :_DIRS_RMAK_:/debian-testing-amd64-DVD-1_preseed.iso                                  -                           -               -                                           :_DIRS_LOAD_:/debian-testing/install.amd/initrd.gz                                    :_DIRS_LOAD_:/debian-testing/install.amd/vmlinuz                                      :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		...
		"dvd             s               fedora-41                               Fedora%20Server%2041                    fedora-41               fedora-41               2024-10-29      2025-11-19      https://download.fedoraproject.org/pub/fedora/linux/releases/41/Server/x86_64/iso/Fedora-Server-dvd-x86_64-41-[0-9.]*.iso                       https://download.fedoraproject.org/pub/fedora/linux/releases/41/Server/x86_64/iso/Fedora-Server-dvd-x86_64-41-1.4.iso                           -                           -               -               :_DIRS_ISOS_:/Fedora-Server-dvd-x86_64-41-1.4.iso                                     2024-10-24%2014:48:35+09    2818572288      Fedora-S-dvd-x86_64-41                      :_DIRS_RMAK_:/Fedora-Server-dvd-x86_64-41-1.4_kickstart.iso                           -                           -               -                                           :_DIRS_LOAD_:/fedora-41/images/pxeboot/initrd.img                                     :_DIRS_LOAD_:/fedora-41/images/pxeboot/vmlinuz                                        :_DIRS_CONF_:/kickstart/ks_fedora-41_dvd.cfg                                          -                           :_DIRS_HGFS_:/linux/fedora                                                           "	\
		"dvd             s               fedora-42                               Fedora%20Server%2042                    fedora-42               fedora-42               2025-04-15      2026-05-13      https://download.fedoraproject.org/pub/fedora/linux/releases/42/Server/x86_64/iso/Fedora-Server-dvd-x86_64-42-[0-9.]*.iso                       https://download.fedoraproject.org/pub/fedora/linux/releases/42/Server/x86_64/iso/Fedora-Server-dvd-x86_64-42-1.1.iso                           -                           -               -               :_DIRS_ISOS_:/Fedora-Server-dvd-x86_64-42-1.1.iso                                     2025-04-09%2012:01:30+09    2925920256      Fedora-S-dvd-x86_64-42                      :_DIRS_RMAK_:/Fedora-Server-dvd-x86_64-42-1.1_kickstart.iso                           -                           -               -                                           :_DIRS_LOAD_:/fedora-42/images/pxeboot/initrd.img                                     :_DIRS_LOAD_:/fedora-42/images/pxeboot/vmlinuz                                        :_DIRS_CONF_:/kickstart/ks_fedora-42_dvd.cfg                                          -                           :_DIRS_HGFS_:/linux/fedora                                                           "	\
		"dvd             s               centos-stream-9                         CentOS%20Stream%209                     centos-stream-9         centos-stream-9         2021-12-03      2027-05-31      https://ftp.iij.ad.jp/pub/linux/centos-stream/9-stream/BaseOS/x86_64/iso/CentOS-Stream-9-latest-x86_64-dvd1.iso                                 https://ftp.iij.ad.jp/pub/linux/centos-stream/9-stream/BaseOS/x86_64/iso/CentOS-Stream-9-latest-x86_64-dvd1.iso                                 -                           -               -               :_DIRS_ISOS_:/CentOS-Stream-9-latest-x86_64-dvd1.iso                                  2025-04-14%2004:09:22+09    12827557888     CentOS-Stream-9-BaseOS-x86_64               :_DIRS_RMAK_:/CentOS-Stream-9-latest-x86_64-dvd1_kickstart.iso                        -                           -               -                                           :_DIRS_LOAD_:/centos-stream-9/images/pxeboot/initrd.img                               :_DIRS_LOAD_:/centos-stream-9/images/pxeboot/vmlinuz                                  :_DIRS_CONF_:/kickstart/ks_centos-stream-9_dvd.cfg                                    -                           :_DIRS_HGFS_:/linux/centos                                                           "	\
		"dvd             s               centos-stream-10                        CentOS%20Stream%2010                    centos-stream-10        centos-stream-10        2024-12-12      2030-01-01      https://ftp.iij.ad.jp/pub/linux/centos-stream/10-stream/BaseOS/x86_64/iso/CentOS-Stream-10-latest-x86_64-dvd1.iso                               https://ftp.iij.ad.jp/pub/linux/centos-stream/10-stream/BaseOS/x86_64/iso/CentOS-Stream-10-latest-x86_64-dvd1.iso                               -                           -               -               :_DIRS_ISOS_:/CentOS-Stream-10-latest-x86_64-dvd1.iso                                 2025-04-15%2020:05:55+09    7608401920      CentOS-Stream-10-BaseOS-x86_64              :_DIRS_RMAK_:/CentOS-Stream-10-latest-x86_64-dvd1_kickstart.iso                       -                           -               -                                           :_DIRS_LOAD_:/centos-stream-10/images/pxeboot/initrd.img                              :_DIRS_LOAD_:/centos-stream-10/images/pxeboot/vmlinuz                                 :_DIRS_CONF_:/kickstart/ks_centos-stream-10_dvd.cfg                                   -                           :_DIRS_HGFS_:/linux/centos                                                           "	\
		"dvd             s               almalinux-9                             Alma%20Linux%209                        almalinux-9             almalinux-9.5           2024-11-18      -               https://repo.almalinux.org/almalinux/9/isos/x86_64/AlmaLinux-9-latest-x86_64-dvd.iso                                                            https://repo.almalinux.org/almalinux/9/isos/x86_64/AlmaLinux-9-latest-x86_64-dvd.iso                                                            -                           -               -               :_DIRS_ISOS_:/AlmaLinux-9-latest-x86_64-dvd.iso                                       2024-11-13%2009:59:46+09    11382292480     AlmaLinux-9-5-x86_64-dvd                    :_DIRS_RMAK_:/AlmaLinux-9-latest-x86_64-dvd_kickstart.iso                             -                           -               -                                           :_DIRS_LOAD_:/almalinux-9/images/pxeboot/initrd.img                                   :_DIRS_LOAD_:/almalinux-9/images/pxeboot/vmlinuz                                      :_DIRS_CONF_:/kickstart/ks_almalinux-9_dvd.cfg                                        -                           :_DIRS_HGFS_:/linux/almalinux                                                        "	\
		"dvd             s               rockylinux-9                            Rocky%20Linux%209                       rockylinux-9            rockylinux-9.5          2024-11-19      -               https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9-latest-x86_64-dvd.iso                                                           https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9-latest-x86_64-dvd.iso                                                           -                           -               -               :_DIRS_ISOS_:/Rocky-9-latest-x86_64-dvd.iso                                           2024-11-16%2004:23:15+09    11510087680     Rocky-9-5-x86_64-dvd                        :_DIRS_RMAK_:/Rocky-9-latest-x86_64-dvd_kickstart.iso                                 -                           -               -                                           :_DIRS_LOAD_:/rockylinux-9/images/pxeboot/initrd.img                                  :_DIRS_LOAD_:/rockylinux-9/images/pxeboot/vmlinuz                                     :_DIRS_CONF_:/kickstart/ks_rockylinux-9_dvd.cfg                                       -                           :_DIRS_HGFS_:/linux/rocky                                                            "	\
		"dvd             s               miraclelinux-9                          Miracle%20Linux%209                     miraclelinux-9          miraclelinux-9.4        2024-09-02      -               https://repo.dist.miraclelinux.net/miraclelinux/isos/9.[0-9.]*-released/x86_64/MIRACLELINUX-9.[0-9.]*-rtm-x86_64.iso                            https://repo.dist.miraclelinux.net/miraclelinux/isos/9.4-released/x86_64/MIRACLELINUX-9.4-rtm-x86_64.iso                                        -                           -               -               :_DIRS_ISOS_:/MIRACLELINUX-9.4-rtm-x86_64.iso                                         2024-08-23%2005:57:18+09    10582161408     MIRACLE-LINUX-9-4-x86_64                    :_DIRS_RMAK_:/MIRACLELINUX-9.4-rtm-x86_64_kickstart.iso                               -                           -               -                                           :_DIRS_LOAD_:/miraclelinux-9/images/pxeboot/initrd.img                                :_DIRS_LOAD_:/miraclelinux-9/images/pxeboot/vmlinuz                                   :_DIRS_CONF_:/kickstart/ks_miraclelinux-9_dvd.cfg                                     -                           :_DIRS_HGFS_:/linux/miraclelinux                                                     "	\
		"dvd             s               opensuse-leap-15.6                      openSUSE%20Leap%2015.6                  opensuse-leap-15.6      opensuse-leap-15.6      2024-06-12      2025-12-31      https://ftp.riken.jp/Linux/opensuse/distribution/leap/15.6/iso/openSUSE-Leap-15.6-DVD-x86_64-Media.iso                                          https://ftp.riken.jp/Linux/opensuse/distribution/leap/15.6/iso/openSUSE-Leap-15.6-DVD-x86_64-Current.iso                                        -                           -               -               :_DIRS_ISOS_:/openSUSE-Leap-15.6-DVD-x86_64-Media.iso                                 2024-06-20%2011:56:54+09    4631560192      openSUSE-Leap-15.6-DVD-x86_64710            :_DIRS_RMAK_:/openSUSE-Leap-15.6-DVD-x86_64-Media_autoyast.iso                        -                           -               -                                           :_DIRS_LOAD_:/opensuse-leap-15.6/boot/x86_64/loader/initrd                            :_DIRS_LOAD_:/opensuse-leap-15.6/boot/x86_64/loader/linux                             :_DIRS_CONF_:/autoyast/autoinst_leap-15.6_dvd.xml                                     -                           :_DIRS_HGFS_:/linux/opensuse                                                         "	\
		"dvd             s               opensuse-leap-16.0                      openSUSE%20Leap%2016.0                  opensuse-leap-16.0      opensuse-leap-16.0      2025-10-xx      20xx-xx-xx      https://ftp.riken.jp/Linux/opensuse/distribution/leap/16.0/iso/openSUSE-Leap-16.0-DVD-x86_64-Media.iso                                          https://ftp.riken.jp/Linux/opensuse/distribution/leap/16.0/iso/openSUSE-Leap-16.0-DVD-x86_64-Current.iso                                        -                           -               -               :_DIRS_ISOS_:/openSUSE-Leap-16.0-DVD-x86_64-Media.iso                                 -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/opensuse-leap-16.0/boot/x86_64/loader/initrd                            :_DIRS_LOAD_:/opensuse-leap-16.0/boot/x86_64/loader/linux                             :_DIRS_CONF_:/autoyast/autoinst_leap-16.0_dvd.xml                                     -                           :_DIRS_HGFS_:/linux/opensuse                                                         "	\
		"dvd             s               opensuse-tumbleweed                     openSUSE%20Tumbleweed                   opensuse-tumbleweed     opensuse-tumbleweed     2014-11-xx      20xx-xx-xx      https://ftp.riken.jp/Linux/opensuse/tumbleweed/iso/openSUSE-Tumbleweed-DVD-x86_64-Current.iso                                                   https://ftp.riken.jp/Linux/opensuse/tumbleweed/iso/openSUSE-Tumbleweed-DVD-x86_64-Current.iso                                                   -                           -               -               :_DIRS_ISOS_:/openSUSE-Tumbleweed-DVD-x86_64-Current.iso                              2025-04-14%2017:29:38+09    4635754496      openSUSE-Tumbleweed-DVD-x86_64              :_DIRS_RMAK_:/openSUSE-Tumbleweed-DVD-x86_64-Current_autoyast.iso                     -                           -               -                                           :_DIRS_LOAD_:/opensuse-tumbleweed/boot/x86_64/loader/initrd                           :_DIRS_LOAD_:/opensuse-tumbleweed/boot/x86_64/loader/linux                            :_DIRS_CONF_:/autoyast/autoinst_tumbleweed_dvd.xml                                    -                           :_DIRS_HGFS_:/linux/opensuse                                                         "	\
		"dvd             s               windows-10                              Windows%2010                            windows-10.0            -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/Win10_22H2_Japanese_x64.iso                                             2022-10-18%2015:21:50+09    6003816448      CCCOMA_X64FRE_JA-JP_DV9                     -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/Windows10                                                      "	\
		"dvd             s               windows-11                              Windows%2011                            windows-11.0            -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/Win11_24H2_Japanese_x64.iso                                             2024-10-01%2012:18:50+09    5751373824      CCCOMA_X64FRE_JA-JP_DV9                     -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/Windows11                                                      "	\
		...
		"live_install    s               ubuntu-desktop-25.04                    Ubuntu%2025.04%20Desktop                ubuntu-25.04            ubuntu-25.04            2025-04-17      2026-01-xx      https://releases.ubuntu.com/25.04/ubuntu-25.04[0-9.]*-desktop-amd64.iso                                                                         https://releases.ubuntu.com/25.04/ubuntu-25.04-desktop-amd64.iso                                                                                -                           -               -               :_DIRS_ISOS_:/ubuntu-25.04-desktop-amd64.iso                                          2025-04-15%2018:47:56+09    6278520832      Ubuntu%2025.04%20amd64                      :_DIRS_RMAK_:/ubuntu-25.04-desktop-amd64_nocloud.iso                                  -                           -               -                                           :_DIRS_LOAD_:/ubuntu-desktop-25.04/casper/initrd                                      :_DIRS_LOAD_:/ubuntu-desktop-25.04/casper/vmlinuz                                     :_DIRS_CONF_:/nocloud/ubuntu_desktop                                                  -                           :_DIRS_HGFS_:/linux/ubuntu                                                           "	\
		"live_install    m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"live            m               menu-entry                              Live%20media%20Live%20mode              -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"live            s               debian-live-11                          Debian%2011%20Live                      debian-11.0             debian-11.0             2021-08-14      2024-08-15      https://cdimage.debian.org/cdimage/archive/latest-oldstable-live/amd64/iso-hybrid/debian-live-11.[0-9.]*-amd64-lxde.iso                         https://cdimage.debian.org/cdimage/archive/latest-oldstable-live/amd64/iso-hybrid/debian-live-11.11.0-amd64-lxde.iso                            -                           -               -               :_DIRS_ISOS_:/debian-live-11.11.0-amd64-lxde.iso                                      2024-08-31%2015:15:29+09    2566914048      d-live%2011.11.0%20lx%20amd64               :_DIRS_RMAK_:/debian-live-11.11.0-amd64-lxde_preseed.iso                              -                           -               -                                           :_DIRS_LOAD_:/debian-live-11/live/initrd.img-5.10.0-32-amd64                          :_DIRS_LOAD_:/debian-live-11/live/vmlinuz-5.10.0-32-amd64                             -                                                                                     -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"live            s               debian-live-12                          Debian%2012%20Live                      debian-12.0             debian-12.0             2023-06-10      2026-06-xx      https://cdimage.debian.org/cdimage/release/current-live/amd64/iso-hybrid/debian-live-12.[0-9.]*-amd64-lxde.iso                                  https://cdimage.debian.org/cdimage/release/current-live/amd64/iso-hybrid/debian-live-12.10.0-amd64-lxde.iso                                     -                           -               -               :_DIRS_ISOS_:/debian-live-12.10.0-amd64-lxde.iso                                      2025-03-15%2009:09:36+09    3181445120      d-live%2012.10.0%20ld%20amd64               :_DIRS_RMAK_:/debian-live-12.10.0-amd64-lxde_preseed.iso                              -                           -               -                                           :_DIRS_LOAD_:/debian-live-12/live/initrd.img                                          :_DIRS_LOAD_:/debian-live-12/live/vmlinuz                                             -                                                                                     -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"live            s               debian-live-13                          Debian%2013%20Live                      debian-13.0             debian-13.0             2025-xx-xx      20xx-xx-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/debian-live-13.0.0-amd64-lxde.iso                                       -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/debian-live-13/live/initrd.img                                          :_DIRS_LOAD_:/debian-live-13/live/vmlinuz                                             -                                                                                     -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		"live            s               debian-live-testing                     Debian%20testing%20Live                 debian-testing          debian-testing          20xx-xx-xx      20xx-xx-xx      https://cdimage.debian.org/cdimage/weekly-live-builds/amd64/iso-hybrid/debian-live-testing-amd64-lxde.iso                                       https://cdimage.debian.org/cdimage/weekly-live-builds/amd64/iso-hybrid/debian-live-testing-amd64-lxde.iso                                       -                           -               -               :_DIRS_ISOS_:/debian-live-testing-amd64-lxde.iso                                      2025-04-14%2002:26:27+09    3683778560      d-live%20testing%20ld%20amd64               :_DIRS_RMAK_:/debian-live-testing-amd64-lxde_preseed.iso                              -                           -               -                                           :_DIRS_LOAD_:/debian-live-testing/live/initrd.img                                     :_DIRS_LOAD_:/debian-live-testing/live/vmlinuz                                        -                                                                                     -                           :_DIRS_HGFS_:/linux/debian                                                           "	\
		...
		"live            s               ubuntu-desktop-24.04                    Ubuntu%2024.04%20Desktop                ubuntu-24.04            ubuntu-24.04            2024-04-25      2029-05-31      https://releases.ubuntu.com/24.04/ubuntu-24.04[0-9.]*-desktop-amd64.iso                                                                         https://releases.ubuntu.com/24.04/ubuntu-24.04.2-desktop-amd64.iso                                                                              -                           -               -               :_DIRS_ISOS_:/ubuntu-24.04.2-desktop-amd64.iso                                        2025-02-15%2009:16:38+09    6343219200      Ubuntu%2024.04.2%20LTS%20amd64              :_DIRS_RMAK_:/ubuntu-24.04.2-desktop-amd64_nocloud.iso                                -                           -               -                                           :_DIRS_LOAD_:/ubuntu-desktop-24.04/casper/initrd                                      :_DIRS_LOAD_:/ubuntu-desktop-24.04/casper/vmlinuz                                     -                                                                                     -                           :_DIRS_HGFS_:/linux/ubuntu                                                           "	\
		"live            s               ubuntu-desktop-24.10                    Ubuntu%2024.10%20Desktop                ubuntu-24.10            ubuntu-24.10            2024-10-10      2025-07-xx      https://releases.ubuntu.com/24.10/ubuntu-24.10[0-9.]*-desktop-amd64.iso                                                                         https://releases.ubuntu.com/24.10/ubuntu-24.10-desktop-amd64.iso                                                                                -                           -               -               :_DIRS_ISOS_:/ubuntu-24.10-desktop-amd64.iso                                          2024-10-09%2014:32:32+09    5665497088      Ubuntu%2024.10%20amd64                      :_DIRS_RMAK_:/ubuntu-24.10-desktop-amd64_nocloud.iso                                  -                           -               -                                           :_DIRS_LOAD_:/ubuntu-desktop-24.10/casper/initrd                                      :_DIRS_LOAD_:/ubuntu-desktop-24.10/casper/vmlinuz                                     -                                                                                     -                           :_DIRS_HGFS_:/linux/ubuntu                                                           "	\
		"live            s               ubuntu-desktop-25.04                    Ubuntu%2025.04%20Desktop                ubuntu-25.04            ubuntu-25.04            2025-04-17      2026-01-xx      https://releases.ubuntu.com/25.04/ubuntu-25.04[0-9.]*-desktop-amd64.iso                                                                         https://releases.ubuntu.com/25.04/ubuntu-25.04-desktop-amd64.iso                                                                                -                           -               -               :_DIRS_ISOS_:/ubuntu-25.04-desktop-amd64.iso                                          2025-04-15%2018:47:56+09    6278520832      Ubuntu%2025.04%20amd64                      :_DIRS_RMAK_:/ubuntu-25.04-desktop-amd64_nocloud.iso                                  -                           -               -                                           :_DIRS_LOAD_:/ubuntu-desktop-25.04/casper/initrd                                      :_DIRS_LOAD_:/ubuntu-desktop-25.04/casper/vmlinuz                                     -                                                                                     -                           :_DIRS_HGFS_:/linux/ubuntu                                                           "	\
		"live            m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"tool            m               menu-entry                              System%20tools                          -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"tool            s               memtest86plus                           Memtest86+%207.20                       memtest86plus           -                       -               -               https://www.memtest.org/download/v7.20/mt86plus_7.20_64.grub.iso.zip                                                                            https://www.memtest.org/download/v7.20/mt86plus_7.20_64.grub.iso.zip                                                                            -                           -               -               :_DIRS_ISOS_:/mt86plus_7.20_64.grub.iso                                               2024-11-11%2009:15:12+09    19988480        MT86PLUS_64                                 -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/memtest86plus/EFI/BOOT/memtest                                          :_DIRS_LOAD_:/memtest86plus/boot/memtest                                              -                                                                                     -                           :_DIRS_HGFS_:/linux/memtest86+                                                       "	\
		"tool            s               winpe-x86                               WinPE%20x86                             winpe-x86               -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/WinPEx86.iso                                                            -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/WinPE                                                          "	\
		"tool            s               winpe-x64                               WinPE%20x64                             winpe-x64               -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/WinPEx64.iso                                                            2024-10-21%2012:19:39+09    469428224       CD_ROM                                      -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/WinPE                                                          "	\
		"tool            s               ati2020x86                              ATI2020x86                              ati2020x86              -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/WinPE_ATI2020x86.iso                                                    2022-01-28%2013:07:12+09    555139072       CD_ROM                                      -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/ati                                                            "	\
		"tool            s               ati2020x64                              ATI2020x64                              ati2020x64              -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/WinPE_ATI2020x64.iso                                                    2022-01-28%2013:12:34+09    630548480       CD_ROM                                      -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           :_DIRS_HGFS_:/windows/ati                                                            "	\
		"tool            m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"custom_live     m               menu-entry                              Custom%20Live%20Media                   -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-debian-11-bullseye                 Live%20Debian%2011                      debian-11.0             debian-11.0             2021-08-14      2024-08-15      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-debian-11-bullseye-amd64.iso                                       -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-debian-11-bullseye/live/initrd.img                                 :_DIRS_LOAD_:/live-debian-11-bullseye/live/vmlinuz                                    -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-debian-12-bookworm                 Live%20Debian%2012                      debian-12.0             debian-12.0             2023-06-10      2026-06-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-debian-12-bookworm-amd64.iso                                       -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-debian-12-bookworm/live/initrd.img                                 :_DIRS_LOAD_:/live-debian-12-bookworm/live/vmlinuz                                    -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-debian-13-trixie                   Live%20Debian%2013                      debian-13.0             debian-13.0             2025-xx-xx      20xx-xx-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-debian-13-trixie-amd64.iso                                         -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-debian-13-trixie/live/initrd.img                                   :_DIRS_LOAD_:/live-debian-13-trixie/live/vmlinuz                                      -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-debian-xx-unstable                 Live%20Debian%20xx                      debian-sid              debian-sid              20xx-xx-xx      20xx-xx-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-debian-xx-unstable-amd64.iso                                       -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-debian-xx-unstable/live/initrd.img                                 :_DIRS_LOAD_:/live-debian-xx-unstable/live/vmlinuz                                    -                                                                                     -                           -                                                                                    "	\
		...
		"custom_live     s               live-ubuntu-24.04-noble                 Live%20Ubuntu%2024.04                   ubuntu-24.04            ubuntu-24.04            2024-04-25      2029-05-31      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-ubuntu-24.04-noble-amd64.iso                                       -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-ubuntu-24.04-noble/live/initrd.img                                 :_DIRS_LOAD_:/live-ubuntu-24.04-noble/live/vmlinuz                                    -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-ubuntu-24.10-oracular              Live%20Ubuntu%2024.10                   ubuntu-24.10            ubuntu-24.10            2024-10-10      2025-07-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-ubuntu-24.10-oracular-amd64.iso                                    -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-ubuntu-24.10-oracular/live/initrd.img                              :_DIRS_LOAD_:/live-ubuntu-24.10-oracular/live/vmlinuz                                 -                                                                                     -                           -                                                                                    "	\
		"custom_live     s               live-ubuntu-25.04-plucky                Live%20Ubuntu%2025.04                   ubuntu-25.04            ubuntu-25.04            2025-04-17      2026-01-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               :_DIRS_ISOS_:/live-ubuntu-25.04-plucky-amd64.iso                                      -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/live-ubuntu-25.04-plucky/live/initrd.img                                :_DIRS_LOAD_:/live-ubuntu-25.04-plucky/live/vmlinuz                                   -                                                                                     -                           -                                                                                    "	\
		"custom_live     m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"custom_netinst  m               menu-entry                              Custom%20Initramfs%20boot               -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"custom_netinst  s               netinst-debian-11                       Net%20Installer%20Debian%2011           debian-11.0             debian-11.0             2021-08-14      2024-08-15      -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/netinst-debian-11/initrd.gz_debian-11                                   :_DIRS_LOAD_:/netinst-debian-11/linux_debian-11                                       :_DIRS_CONF_:/preseed/ps_debian_server_old.cfg                                        -                           -                                                                                    "	\
		"custom_netinst  s               netinst-debian-12                       Net%20Installer%20Debian%2012           debian-12.0             debian-12.0             2023-06-10      2026-06-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/netinst-debian-12/initrd.gz_debian-12                                   :_DIRS_LOAD_:/netinst-debian-12/linux_debian-12                                       :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           -                                                                                    "	\
		"custom_netinst  s               netinst-debian-13                       Net%20Installer%20Debian%2013           debian-13.0             debian-13.0             2025-xx-xx      20xx-xx-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/netinst-debian-13/initrd.gz_debian-13                                   :_DIRS_LOAD_:/netinst-debian-13/linux_debian-13                                       :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           -                                                                                    "	\
		"custom_netinst  s               netinst-debian-sid                      Net%20Installer%20Debian%20sid          debian-sid              debian-sid              20xx-xx-xx      20xx-xx-xx      -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           :_DIRS_LOAD_:/netinst-debian-sid/initrd.gz_debian-sid                                 :_DIRS_LOAD_:/netinst-debian-sid/linux_debian-sid                                     :_DIRS_CONF_:/preseed/ps_debian_server.cfg                                            -                           -                                                                                    "	\
		"custom_netinst  m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"system          m               menu-entry                              System%20command                        -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"system          s               hdt                                     Hardware%20info                         -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               hdt.c32                                                                               -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"system          s               restart                                 System%20restart                        -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               reboot.c32                                                                            -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"system          s               shutdown                                System%20shutdown                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               poweroff.c32                                                                          -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
		"system          m               menu-entry                              -                                       -                       -                       -               -               -                                                                                                                                               -                                                                                                                                               -                           -               -               -                                                                                     -                           -               -                                           -                                                                                     -                           -               -                                           -                                                                                     -                                                                                     -                                                                                     -                           -                                                                                    "	\
	)
	...
	do
		...
		case "${_PATH}" in
			...
			*/preseed/*  )
				...
				_BASE="${_FNAM%"${_EXTN}"}"
				_WORK="${_PATH%"${_FNAM}"}"
				printf "%20.20s: %s\n" "copy" "${_WORK%%/}/${_BASE%_*}*${_EXTN}" 1>&2
				cp -a "${_WORK%%/}/${_BASE%_*}"*"${_EXTN}" "${_DIRS}"
				chmod ugo+r-xw "${_WORK}/"*
				;;
			*/windows/*  ) ;;
			*            ) ;;
		esac
...
#		_PATH="${_DWRK}/${_TGET_LIST[17]##*/}.tmp"			# file path
#		_FGRU="$(find .             -iname 'grubx64.efi'                              -type f -printf "%P" || true)"
#		_FBOT="$(find .             -iname 'bootx64.efi'                              -type f -printf "%P" || true)"
#		_FBIN="$(find .          \( -iname 'isolinux.bin' -o -iname 'eltorito.img' \) -type f -printf "%P" || true)"
#		_FHBR="$(find /usr/lib       -name 'isohdpfx.bin'                             -type f              || true)"
#		_FCAT="$(find .          \( -iname 'boot.cat'     -o -iname 'boot.catalog' \) -type f -printf "%P" || true)"
#		_DBOT="$(find . -maxdepth 1 -iname 'boot'                                     -type d -printf "%P" || true)"
#		_DEFI="$(find . -maxdepth 1 -iname 'efi'                                      -type d -printf "%P" || true)"
#		# --- create efi image ------------------------------------------------
#		_FEFI="${_DWRK}/efiboot.img"
#		case "${_TGET_LIST[2]%%-*}" in
#			debian      | \
#			ubuntu      ) _FEFI="boot/grub/efi.img";;
#			fedora      | \
#			centos      | \
#			almalinux   | \
#			rockylinux  | \
#			miraclelinux) _FEFI="images/efiboot.img";;
#			opensuse    ) _FEFI="boot/x86_64/efi";;
#			*           ) ;;
#		esac
##		_FEFI="efiboot.img"
#		if [[ ! -e "${_FEFI}" ]]; then
#			dd if=/dev/zero of="${_FEFI:?}" bs=1k count=1440
#			mkfs.msdos -F 12 -M 0xf8 "${_FEFI:?}"
#			mkdir -p "${_MNTP}"
#			mount -o loop "${_FEFI}" "${_MNTP}"
#			mkdir -p "${_MNTP}/EFI/BOOT"
#			if [[ -n "${_FBOT}" ]]; then
#				cp -a "${_FBOT}" "${_MNTP}/EFI/BOOT"
#			fi
#			sync
#			umount "${_MNTP}"
#		fi
...
#		fi
#		if ! nice -n "${_NICE_VALU:-19}" xorrisofs \
#		    -quiet \
...
#		fi
		...
		#                              Append FILE after image. TYPE is hex: 0x.. or a GUID to be used if -appended_part_as_gpt.
