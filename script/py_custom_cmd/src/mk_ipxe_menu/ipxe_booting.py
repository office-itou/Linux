...
set ipv4addr :_IPV4_ADDR_:
set ipv4mask :_IPV4_MASK_:
set ipv4gway :_IPV4_GWAY_:
set ipv4nsvr :_IPV4_NSVR_:
form                                            Configure Network Options
item hostname                                   Hostname
item ethrname                                   Interface
item ipv4addr                                   IPv4 address
item ipv4mask                                   IPv4 netmask (example: 24 or 255.255.255.0)
item ipv4gway                                   IPv4 gateway
item ipv4nsvr                                   Name servers
...
item otherprm                                   Other options
item debugprm                                   Debug options
isset ${openmenu} && present ||
...
item --gap --                                   Interface: -----> ${ethrname}
item --gap --                                   IPv4 address: --> ${ipv4addr}/${ipv4cidr}
item --gap --                                   IPv4 netmask: --> ${ipv4mask}
item --gap --                                   IPv4 gateway: --> ${ipv4gway}
item --gap --                                   Names ervers: --> ${ipv4nsvr}
item --gap --                                   Auto instal: ---> ${autoinst}
item --gap --                                   Language: ------> ${language}
item --gap --                                   Network: -------> ${networks}
item --gap --                                   Other options: -> ${otherprm}
item --gap --                                   Debug options: -> ${debugprm}
item --gap --
item --gap --                                   [ Return menu ]
item -- return                                  - Return
item --gap --                                   [ Action ]
item -- booting                                 - OS booting
item -- setting                                 - Set parameters
