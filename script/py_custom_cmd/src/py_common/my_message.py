...
colsize_mode = 8
colsize_func = (infosystem.data.columns - (colsize_mode + 2 )) // 2 if infosystem.data.columns < 100 else 50
colsize_mesg = infosystem.data.columns - (colsize_func + colsize_mode + 2)
...
def message_debug(function_name: str, mode: str, message_color: str, message: str):
    text_prog = omit_middle(f"{infosystem.data.program_name}:{function_name}", colsize_func)
    text_mesg = omit_middle(f"{message}", infosystem.data.columns - (colsize_func + colsize_mode + 1))
