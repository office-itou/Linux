...
#		__WORK="${__WORK//\"-\"/\"\"}"
	...
	__DIRS_DATA="${1:-"/srv/user/share/conf/_data"}"

	fnOutput_json "${__DIRS_DATA}/distribution.dat"	# distribution data file
	fnOutput_json "${__DIRS_DATA}/media.dat"		# media data file
#	fnOutput_json "${__DIRS_DATA}/work.txt"
