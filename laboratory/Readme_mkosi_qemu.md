# **mkosiで作成した環境をqemuで起動**

## 概要

mkosi、qemu、novncを利用し作成した環境の起動確認をする。

## 環境

* <details><summary>ツリー図</summary>

    ``` bash:
    $ tree -a --charset C -I "bin|boot|dev|efi|etc|home|init|lib|lib32|lib64|libx32|media|mnt|opt|proc|root|run|sbin|srv|sys|tmp|usr|var" ./mkosi/
    ./mkosi/
...
前提としてmkosi、qemu、novncが起動できる環境であること。

* <details><summary>準備</summary>

    ``` bash:
    mkdir -p ./mkosi/{repository,script}
    wget --output-document=mkosi/repository/apt-conf https://raw.githubusercontent.com/office-itou/Linux/refs/heads/master/conf/_mkosi/repository/apt-conf
    wget --output-document=mkosi/repository/debian-trixie-backports.sources https://raw.githubusercontent.com/office-itou/Linux/refs/heads/master/conf/_mkosi/repository/debian-trixie-backports.sources
    ```

  </details>
* <details><summary>novnc 待機</summary>
...
* <details><summary>mkosi イメージ作成</summary>
  ...
  * <details><summary>mkosi.conf</summary>
...
* <details><summary>qemu 仮想PC起動</summary>
    ...
    -vnc ":0" \
    -nographic \
    -drive "id=disk,file=./mkosi/rootfs,format=raw,if=none" \
    -device "ich9-ahci,id=ahci" \
    -device "ide-hd,drive=disk,bus=ahci.0"
    ```

  </details>
* <details><summary>VNC 接続</summary>
